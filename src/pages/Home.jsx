...
function Hero({ images = [], subtitle, title, desc, chips = [], onSearch, ctaContactLabel }) {
  ...
  return (
    <section className="relative h-[70vh] md:h-[90vh] overflow-hidden rounded-2xl shadow-lg parallax-container"> {/* Ubah height & tambah class */}
        ...
        {title && (
          <motion.h1
            ...
            className="
              ...
              text-[clamp(28px,6vw,56px)] tracking-tight
